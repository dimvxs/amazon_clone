...
export default function RecommendR3SliderCard({ 
  ...
  return (
    <div className="flex flex-col w-[373px] h-[454px] bg-surface-11 rounded-[15px] border border-[#2F3A52] overflow-hidden shrink-0 shadow-lg">
      ...
      {/* 2. Центральная часть (Arrows + Img) */}
      <div className="relative flex-grow flex items-center justify-center">
        
        {/* Кнопка влево (arrow_left) */}
        <button className="absolute left-[16px] z-10 w-[55px] h-[69px] bg-[#1A2030]/50 rounded-[10px] flex items-center justify-center hover:bg-[#1A2030]/70 transition-colors">
        ...
        <div className="relative w-[181px] h-[255px]">
          <Image
            src={imageSrc}
            alt={productName}
            fill
        ...
        <button className="absolute right-[16px] z-10 w-[55px] h-[69px] bg-[#1A2030]/50 rounded-[10px] flex items-center justify-center hover:bg-[#1A2030]/70 transition-colors">
          <svg width="26" height="44" viewBox="0 0 26 44" fill="none" xmlns="http://www.w3.org/2000/svg">
